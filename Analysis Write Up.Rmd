...
This markdown contains the analysis for "The Perceptual Attraction of Predominant Chords".
...
> This was last updated on March, 19th 2021 after a second R&R
...
rm_musical_plot <- rm_musical_plot +  
  scale_color_manual(
    limits = c("Chromatic PDs", "Diatonic PDs","Bridge Chords", "Non PDs"),
    labels = c("Chromatic PDs", "Diatonic PDs","Bridge Chords", "Non PDs"),
    values = c(
      "#440154FF",
      "#39568CFF",
      "#55C667FF",
...
helper <- data.frame(color = c("yellow","green","blue","purple"),
            chord_family = c("not_pd","bridge_chords","common_pd","chromatic_pd") )
...
dist_cluster_object %>%
  ...
  set("labels_col", c(
    ...
    "#440154FF",  # Purple
    "#440154FF",  # Purple
    "#440154FF",  # Purple (Viio/V)
    "#39568CFF",  # Blue (iv7)
    "#440154FF",  # Purple (viio7/V)
    "#440154FF",  # Purple V/V
    "#440154FF",  # Purple V7/V
    "#39568CFF",  # Blue IV
    "#39568CFF",  # Blue IV7
    
    "#FDE725FF",  # vii full dim 7
    "#39568CFF",  # Blue
    "#39568CFF",  # Blue
    "#39568CFF",  # Blue
    "#440154FF",  # Purple (N6)
    
    "#FDE725FF",  # yellow (vii07)
    "#39568CFF",  # Blue
    "#39568CFF",  # Blue
    "#FDE725FF",  # #55C667FF (i7)
    "#55C667FF",  # III7
    "#55C667FF",  # VI7 
    "#55C667FF",  # III
    "#55C667FF",  # VI
